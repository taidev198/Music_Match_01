 ...
 * in Music_Match__1.
 */
public class PlaylistTabAdapter extends BaseAdapter<Playlist, OnRecyclerItemClickListener<Playlist>, PlaylistTabAdapter.PlaylistViewHolder> {
    ...
    public static class PlaylistViewHolder extends BaseTrackViewHolder<Playlist, OnRecyclerItemClickListener<Playlist>> {

        private CardView mPlaylistArt;
        private ImageView mTrackArt;
        private String mSubTitle;

        public PlaylistViewHolder(Context context, @NonNull View itemView, OnRecyclerItemClickListener<Playlist> callback) {
        ...
        public void bindData(Playlist playlist) {
            if (playlist != null) {
                mTextTitle.setText(playlist.getPlaylistName());
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append(getNumberAlbumTrackStr(playlist.getNumSongs()));
                mSubTitle = String.format(stringBuilder.toString(), playlist.getNumSongs());
