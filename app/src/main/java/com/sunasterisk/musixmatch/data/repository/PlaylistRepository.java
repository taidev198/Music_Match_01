...
public class PlaylistRepository implements PlaylistDataSource.Local {
    ...
    public static PlaylistRepository getsIntance(PlaylistDataSource.Local local) {
        if (sInstance == null) {
    ...
    @Override
    public long getIdForPlaylist(String name) {
        return mLocal.getIdForPlaylist(name);
    }
